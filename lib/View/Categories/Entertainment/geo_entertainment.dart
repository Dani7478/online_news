...
class GeoEntertainmentChannel extends StatefulWidget {
  @override
  State<GeoEntertainmentChannel> createState() => _GeoEntertainmentChannelState();
}

class _GeoEntertainmentChannelState extends State<GeoEntertainmentChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://www.geo.tv/rss/1/5';
