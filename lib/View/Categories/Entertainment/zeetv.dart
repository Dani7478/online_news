...
class ZeeTvChannel extends StatefulWidget {
  @override
  State<ZeeTvChannel> createState() => _ZeeTvChannelState();
}

class _ZeeTvChannelState extends State<ZeeTvChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://www.geo.tv/rss/1/53';
