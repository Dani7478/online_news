...
class BBCChannel extends StatefulWidget {
  @override
  State<BBCChannel> createState() => _BBCChannelState();
}

class _BBCChannelState extends State<BBCChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'http://feeds.bbci.co.uk/news/england/london/rss.xml';
