...
class NewTimesChannel extends StatefulWidget {
  @override
  State<NewTimesChannel> createState() => _NewTimesChannelState();
}

class _NewTimesChannelState extends State<NewTimesChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://rss.nytimes.com/services/xml/rss/nyt/World.xml';
              ...
              ? ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, index) {
                    ...
                    String date = DateFormat('MMM dd yyyy')
                        ...
                        String image;
                        if(item.media!.contents!.isEmpty)
                        {
                          image='http://simpleicon.com/wp-content/uploads/loading.png';
                        }
                        else 
                        {
                           image = item.media!.contents![0].url.toString();
                        }
