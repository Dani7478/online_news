...
class ESPNAUSChannel extends StatefulWidget {
  @override
  State<ESPNAUSChannel> createState() => _ESPNAUSChannelState();
}

class _ESPNAUSChannelState extends State<ESPNAUSChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://www.espncricinfo.com/rss/content/story/feeds/2.xml';
