...
class ESPNINDChannel extends StatefulWidget {
  @override
  State<ESPNINDChannel> createState() => _ESPNINDChannelState();
}

class _ESPNINDChannelState extends State<ESPNINDChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://www.espncricinfo.com/rss/content/story/feeds/6.xml';
