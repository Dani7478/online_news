...
class ESPNPAKChannel extends StatefulWidget {
  @override
  State<ESPNPAKChannel> createState() => _ESPNPAKChannelState();
}

class _ESPNPAKChannelState extends State<ESPNPAKChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://www.espncricinfo.com/rss/content/story/feeds/7.xml';
          ...
          isLoading == false
              ? ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, index) {
                    ...
                    // String image =item.categories![2].toString();
                    // print(image);
                    String image='https://thumbs.dreamstime.com/b/orange-progress-bar-loading-sign-white-background-vector-holiday-illustration-222400647.jpg';
