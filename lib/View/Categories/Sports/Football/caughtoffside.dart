...
class CaughtOffSideChannel extends StatefulWidget {
  @override
  State<CaughtOffSideChannel> createState() => _CaughtOffSideChannelState();
}

class _CaughtOffSideChannelState extends State<CaughtOffSideChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://www.caughtoffside.com/feed/';
