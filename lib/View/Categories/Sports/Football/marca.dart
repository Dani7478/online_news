...
class MARCAChannel extends StatefulWidget {
  @override
  State<MARCAChannel> createState() => _MARCAChannelState();
}

class _MARCAChannelState extends State<MARCAChannel> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://e00-marca.uecdn.es/rss/en/index.xml';
          ...
          isLoading == false
              ? ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, index) {
                    ...
                    String description = item.media!.description!.value.toString();
                    print(description);
