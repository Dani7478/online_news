...
class HealthChannels extends StatefulWidget {
  const HealthChannels({Key? key}) : super(key: key);

  @override
  State<HealthChannels> createState() => _HealthChannelsState();
}
      ...
      body: Container(
        child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                'images/geo.png', 'https://www.geo.tv/rss/1/6', 0),
                 SizedBox(height: size.height * 0.05),
            PortionCategory('HeathResources4U', 'All Punjab news',
                'images/zeetv.png', 'https://www.healthresource4u.com/feed', 1),
            //     SizedBox(height: size.height * 0.05),
