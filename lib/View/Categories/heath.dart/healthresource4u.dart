...
class HeathResources4U extends StatefulWidget {
  @override
  State<HeathResources4U> createState() => _HeathResources4UState();
}

class _HeathResources4UState extends State<HeathResources4U> {
  ...
  loadData() async {
    try {
      ...
      const API = 'https://www.healthresource4u.com/feed';
